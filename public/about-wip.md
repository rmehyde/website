...
format. While your browser has all the content and code, it receives it in a format that's friendlier to machines 
than humans. If you're curious for a look yourself, you can see all the [code](https://github.com/rmehyde/website) and 
